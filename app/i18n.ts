...
const i18n = new I18n({
    en: {
        ...
        deleteLog: 'Delete',
        noLogs: 'No logs yet.',
        scrollInstructions: 'Scroll to select',
        ...
        calmOptionHydration: 'Hydration (Drink)',
        calmOptionSnack: 'Snack (Food)',
        calmOptionHygiene: 'Hygiene (Diaper/Bathroom)',
        calmOptionClothing: 'Clothing Adjustment',
        calmOptionDeepPressure: 'Deep Pressure',
        calmOptionJointCompressions: 'Joint Compressions',
        calmOptionBearHugs: 'Bear Hugs',
        calmOptionSwinging: 'Swinging',
        calmOptionRocking: 'Rocking',
        calmOptionHeavyWork: 'Heavy Work',
        calmOptionShowerBath: 'Shower/Bath',
        calmOptionReducedStimulation: 'Reduced Stimulation',
        calmOptionVisualCalming: 'Visual Calming',
...
Tap Review to show stats over time. Show these to your health professional.`,
        ...
        clearDataTitle: 'Erase All App Data?',
        clearDataMessage: 'Are you sure you want to permanently delete ALL of your tracking data, GI logs, and health notes associated with this account? This action cannot be undone.',
        confirmClear: 'Yes, Delete Everything',
        clearDataCancel: 'Cancel',
        clearSuccessTitle: 'Data Erased',
        clearSuccessMessage: 'All of your historical app data has been permanently deleted.',
        clearErrorTitle: 'Error Erasing Data',
        ...
        backupToGoogle: 'Backup Data to Google',
        backupSuccessTitle: 'Backup Successful',
        backupSuccessMessage: 'Your anonymous data is now securely linked to your Google Account.',
        backupErrorTitle: 'Backup Failed',
        restoreSuccessTitle: 'Restore Successful',
        restoreSuccessMessage: 'We found your existing account! Your data has been securely restored.',
    },
    de: { // German
        ...
        scrollInstructions: 'Scrollen zum Auswählen',
    ...
    it: { // Italian
        ...
        scrollInstructions: 'Scorri per selezionare',
    ...
    es: { // Spanish
        ...
        scrollInstructions: 'Desliza para seleccionar',
    ...
    da: { // Danish
        ...
        scrollInstructions: 'Rul for at vælge',
    ...
    uk: { // Ukrainian
        ...
        scrollInstructions: 'Прокрутіть, щоб вибрати',
